...
# This script creates files locally on the current host (jumphost)

set -e

echo "Creating required paths and files for CKS exam locally..."
...
echo "All required paths and files created successfully locally!"
